...
Note that the simple comparison is just `=` in Red. There is `==` too, but it performs a more strict comparison, taking also under account the datatypes of the values:
