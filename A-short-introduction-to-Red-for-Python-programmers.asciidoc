...
You can (and definately should, if you want to master `parse`) check the https://github.com/red/red/wiki/%5BDOC%5D-Parse[dedicated resources for learning `parse`]
