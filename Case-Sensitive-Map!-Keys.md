...
[#1](#1), [#10](10), [#9](#9), [#2](#2), [#6](#6)    I am hoping red and rebolX will become much more introspective and malleable with regard to internals. For example, I might want to replace find with a find that acts more intelligently.  It would be nice to be able to name my version FIND or Find, to distinguish it.  In general, choice is better than no choice.  Few would argue that just because variables don't HAVE to be declared before use they CAN'T be declared before use. Forcing other programmers to subscribe to YOUR naming convention when writing THEIR code is lame...and just not right. You wouldn't like it if it were done against you. -gnat
