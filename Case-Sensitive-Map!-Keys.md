...
[#1](#1), [#2](#2), [#6](#6)  [#9](#9)  I am hoping red and rebolX will become much more introspective and malleable with regard to internals. For example, I might want to replace find with a find that doesn't blow up when it doesn't find what it is looking for.  It would be nice to be able to name my version FIND or Find.  In general, choice is better than no choice.  few would argue that just because variables don't HAVE to be declared before use they CAN'T be declared before use. Forcing other programmers to subscribe to YOUR naming convention when writing THEIR code is lame...and just not right. You wouldn't like it if it were done to you. -gnat
