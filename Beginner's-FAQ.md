...
Type `help` in the Red console to learn how access the built-in documentation. Don't be afraid, Red's internal documentation is very concise so you can get grasp the main information in a glance. Try typing `help help` to see how `help` itself operates.
